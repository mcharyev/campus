...
/**
 * @method RectorOrder|null find($id, $lockMode = null, $lockVersion = null)
 * @method RectorOrder|null findOneBy(array $criteria, array $orderBy = null)
 * @method RectorOrder[]    findAll()
 * @method RectorOrder[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class RectorOrderRepository extends ServiceEntityRepository {

    private $connection;
    private $entityManager;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, RectorOrder::class);
    ...
    public function save(RectorOrder $rectorOrder): void {
        $this->getEntityManager()->persist($rectorOrder);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(RectorOrder $rectorOrder): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(RectorOrder $rectorOrder): void {
        $this->getEntityManager()->remove($rectorOrder);
        $this->getEntityManager()->flush();
        return;
    }
