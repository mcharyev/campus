...
/**
 * @method DisciplineAction|null find($id, $lockMode = null, $lockVersion = null)
 * @method DisciplineAction|null findOneBy(array $criteria, array $orderBy = null)
 * @method DisciplineAction[]    findAll()
 * @method DisciplineAction[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class DisciplineActionRepository extends ServiceEntityRepository
{
    private $connection;
    
    public function __construct(RegistryInterface $registry)
    {
        parent::__construct($registry, DisciplineAction::class);
    ...
    public function save(DisciplineAction $disciplineAction): void {
        $this->getEntityManager()->persist($disciplineAction);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(DisciplineAction $disciplineAction): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(DisciplineAction $disciplineAction): void {
        $this->getEntityManager()->remove($disciplineAction);
        $this->getEntityManager()->flush();
        return;
    }
}
