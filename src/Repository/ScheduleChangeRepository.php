...
/**
 * @method ScheduleChange|null find($id, $lockMode = null, $lockVersion = null)
 * @method ScheduleChange|null findOneBy(array $criteria, array $orderBy = null)
 * @method ScheduleChange[]    findAll()
 * @method ScheduleChange[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class ScheduleChangeRepository extends ServiceEntityRepository {

    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, ScheduleChange::class);
    ...
    public function save(ScheduleChange $scheduleChange): void {
        $this->getEntityManager()->persist($scheduleChange);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(ScheduleChange $scheduleChange): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(ScheduleChange $scheduleChange): void {
        $this->getEntityManager()->remove($scheduleChange);
        $this->getEntityManager()->flush();
        return;
    }
