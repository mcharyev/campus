...
class ReferenceDocumentRepository extends ServiceEntityRepository {
    ...
    public function save(ReferenceDocument $referenceDocument): void {
        $this->getEntityManager()->persist($referenceDocument);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(ReferenceDocument $referenceDocument): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(ReferenceDocument $referenceDocument): void {
