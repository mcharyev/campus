...
/**
 * @method TeacherWorkItem|null find($id, $lockMode = null, $lockVersion = null)
 * @method TeacherWorkItem|null findOneBy(array $criteria, array $orderBy = null)
 * @method TeacherWorkItem[]    findAll()
 * @method TeacherWorkItem[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class TeacherWorkItemRepository extends ServiceEntityRepository {

    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, TeacherWorkItem::class);
    ...
    public function save(TeacherWorkItem $teacherWorkItem): void {
        $this->getEntityManager()->persist($teacherWorkItem);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(TeacherWorkItem $teacherWorkItem): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(TeacherWorkItem $teacherWorkItem): void {
        $this->getEntityManager()->remove($teacherWorkItem);
        $this->getEntityManager()->flush();
        return;
    }
