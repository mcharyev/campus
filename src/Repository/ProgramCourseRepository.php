...
/**
 * @method ProgramCourse|null find($id, $lockMode = null, $lockVersion = null)
 * @method ProgramCourse|null findOneBy(array $criteria, array $orderBy = null)
 * @method ProgramCourse[]    findAll()
 * @method ProgramCourse[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class ProgramCourseRepository extends ServiceEntityRepository {

    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, ProgramCourse::class);
    ...
    public function save(ProgramCourse $programCourse): void {
        $this->getEntityManager()->persist($programCourse);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(ProgramCourse $programCourse): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(ProgramCourse $programCourse): void {
        $this->getEntityManager()->remove($programCourse);
        $this->getEntityManager()->flush();
        return;
    }
