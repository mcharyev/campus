...
/**
 * @method InformationText|null find($id, $lockMode = null, $lockVersion = null)
 * @method InformationText|null findOneBy(array $criteria, array $orderBy = null)
 * @method InformationText[]    findAll()
 * @method InformationText[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class InformationTextRepository extends ServiceEntityRepository {

    private $connection;
    private $entityManager;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, InformationText::class);
    ...
    public function save(InformationText $referenceDocument): void {
        $this->getEntityManager()->persist($referenceDocument);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(InformationText $referenceDocument): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(InformationText $referenceDocument): void {
        $this->getEntityManager()->remove($referenceDocument);
        $this->getEntityManager()->flush();
        return;
    }
