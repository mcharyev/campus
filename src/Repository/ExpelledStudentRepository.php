...
/**
 * @method ExpelledStudent|null find($id, $lockMode = null, $lockVersion = null)
 * @method ExpelledStudent|null findOneBy(array $criteria, array $orderBy = null)
 * @method ExpelledStudent[]    findAll()
 * @method ExpelledStudent[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class ExpelledStudentRepository extends ServiceEntityRepository
{
    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, ExpelledStudent::class);
    ...
    public function save(ExpelledStudent $expelledStudent): void {
        $this->getEntityManager()->persist($expelledStudent);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(ExpelledStudent $expelledStudent): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(ExpelledStudent $expelledStudent): void {
        $this->getEntityManager()->remove($expelledStudent);
        $this->getEntityManager()->flush();
        return;
    }
}
