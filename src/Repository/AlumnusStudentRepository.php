...
/**
 * @method AlumnusStudent|null find($id, $lockMode = null, $lockVersion = null)
 * @method AlumnusStudent|null findOneBy(array $criteria, array $orderBy = null)
 * @method AlumnusStudent[]    findAll()
 * @method AlumnusStudent[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class AlumnusStudentRepository extends ServiceEntityRepository {

    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, AlumnusStudent::class);
    ...
    public function getRecords(array $params = []) {
        ...
        $stmt->execute();
//JSON_EXTRACT(data,\"$.employment_place\") AS employment_place, 
    ...
    public function save(AlumnusStudent $alumnusStudent): void {
        $this->getEntityManager()->persist($alumnusStudent);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(AlumnusStudent $alumnusStudent): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(AlumnusStudent $alumnusStudent): void {
        $this->getEntityManager()->remove($alumnusStudent);
        $this->getEntityManager()->flush();
        return;
    }
