...
/**
 * @method ReportedWork|null find($id, $lockMode = null, $lockVersion = null)
 * @method ReportedWork|null findOneBy(array $criteria, array $orderBy = null)
 * @method ReportedWork[]    findAll()
 * @method ReportedWork[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class ReportedWorkRepository extends ServiceEntityRepository {

    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, ReportedWork::class);
    ...
    public function save(ReportedWork $reportedWork): void {
        $this->getEntityManager()->persist($reportedWork);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(ReportedWork $reportedWork): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(ReportedWork $reportedWork): void {
        $this->getEntityManager()->remove($reportedWork);
        $this->getEntityManager()->flush();
        return;
    }
