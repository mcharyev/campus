...
/**
 * @method CampusBuilding|null find($id, $lockMode = null, $lockVersion = null)
 * @method CampusBuilding|null findOneBy(array $criteria, array $orderBy = null)
 * @method CampusBuilding[]    findAll()
 * @method CampusBuilding[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class CampusBuildingRepository extends ServiceEntityRepository
{
    private $connection;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, CampusBuilding::class);
    ...
    public function save(CampusBuilding $campusBuilding): void {
        $this->getEntityManager()->persist($campusBuilding);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(CampusBuilding $campusBuilding): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(CampusBuilding $campusBuilding): void {
        $this->getEntityManager()->remove($campusBuilding);
        $this->getEntityManager()->flush();
        return;
    }
}
