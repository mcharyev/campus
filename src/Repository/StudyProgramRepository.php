...
class StudyProgramRepository extends ServiceEntityRepository {
    ...
    public function save(StudyProgram $studyProgram): void {
        $this->getEntityManager()->persist($studyProgram);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(StudyProgram $studyProgram): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(StudyProgram $studyProgram): void {
        $this->getEntityManager()->remove($studyProgram);
        $this->getEntityManager()->flush();
        return;
    }
