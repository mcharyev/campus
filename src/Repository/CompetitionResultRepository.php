...
/**
 * @method CompetitionResult|null find($id, $lockMode = null, $lockVersion = null)
 * @method CompetitionResult|null findOneBy(array $criteria, array $orderBy = null)
 * @method CompetitionResult[]    findAll()
 * @method CompetitionResult[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class CompetitionResultRepository extends ServiceEntityRepository
{
    ...
    public function save(CompetitionResult $competitionResult): void {
        $this->getEntityManager()->persist($competitionResult);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(CompetitionResult $competitionResult): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(CompetitionResult $competitionResult): void {
        $this->getEntityManager()->remove($competitionResult);
        $this->getEntityManager()->flush();
        return;
    }
}
