...
class HostelRepository extends ServiceEntityRepository
{
    ...
    public function save(Hostel $hostel): void {
        $this->getEntityManager()->persist($hostel);
    ...
    public function remove(Hostel $hostel): void {
        $this->getEntityManager()->remove($hostel);
        $this->getEntityManager()->flush();
        return;
    }
}
