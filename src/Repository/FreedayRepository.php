...
/**
 * @method Freeday|null find($id, $lockMode = null, $lockVersion = null)
 * @method Freeday|null findOneBy(array $criteria, array $orderBy = null)
 * @method Freeday[]    findAll()
 * @method Freeday[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class FreedayRepository extends ServiceEntityRepository {

    private $connection;
    private $entityManager;

    public function __construct(RegistryInterface $registry) {
        parent::__construct($registry, Freeday::class);
    ...
    public function save(Freeday $freeday): void {
        $this->getEntityManager()->persist($freeday);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(Freeday $freeday): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(Freeday $freeday): void {
        $this->getEntityManager()->remove($freeday);
        $this->getEntityManager()->flush();
        return;
    }
