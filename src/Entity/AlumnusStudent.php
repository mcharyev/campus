...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AlumnusStudentRepository")
 */
class AlumnusStudent extends AbstractStudent {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Group", inversedBy="alumniStudents")
