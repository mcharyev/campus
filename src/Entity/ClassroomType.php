...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ClassroomTypeRepository")
 */
class ClassroomType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Classroom", mappedBy="type")
     */
    private $classrooms;
