...
class LibraryItemManager {
    ...
    //put your code here
    public function createFromRequest(Request $request, Language $language, LibraryUnit $libraryUnit): LibraryItem {
        ...
        $libraryItem->setType($request->request->get('type'))
                ...
                ->setCallNumberOriginal($request->request->get('call_number_original'))
    ...
    public function updateFromRequest(Request $request, LibraryItem $libraryItem, Language $language, LibraryUnit $libraryUnit): LibraryItem {
        $libraryItem->setType($request->request->get('type'))
                ->setMainTitle($request->request->get('main_title'))
                ->setSecondaryTitle($request->request->get('secondary_title'))
                ->setAuthor($request->request->get('author'))
