...
/**
 * @method LibraryItem|null find($id, $lockMode = null, $lockVersion = null)
 * @method LibraryItem|null findOneBy(array $criteria, array $orderBy = null)
 * @method LibraryItem[]    findAll()
 * @method LibraryItem[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class LibraryItemRepository extends ServiceEntityRepository {
    ...
    public function findLikeByField(array $params = []) {
        ...
        $rsm->addRootEntityFromClassMetadata('App\Library\Entity\LibraryItem', 'u');
    ...
    public function save(LibraryItem $libraryItem): void {
        $this->getEntityManager()->persist($libraryItem);
        $this->getEntityManager()->flush();
        return;
    }

    public function update(LibraryItem $libraryItem): void {
        $this->getEntityManager()->flush();
        return;
    }

    public function remove(LibraryItem $libraryItem): void {
        $this->getEntityManager()->remove($libraryItem);
        $this->getEntityManager()->flush();
        return;
    }
