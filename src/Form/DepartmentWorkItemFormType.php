...
class DepartmentWorkItemFormType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        if ($data == null) {
            ...
            if (!empty($options['groupcourse'])) {
                $entity->setStudentGroups($options['groupcourse']);
            }
...
//                    'data' => $entity->getTitle(),
                ...
                ->add('type', ChoiceType::class, [
                    'choices' => [
                        ...
                        WorkRowEnum::getTypeName(WorkRowEnum::EXTRACOURSE) => WorkRowEnum::EXTRACOURSE,
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults([
            'data_class' => DepartmentWorkItem::class,
            'source_path' => '',
            'department' => null,
            'year' => 2019,
            'semester' => 1,
