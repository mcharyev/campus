 ...
 */
final class Version20211115191302 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transcript_course ADD group_code INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transcript_course DROP group_code');
    }
}
