 ...
 */
final class Version20211023065529 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taught_course ADD course_code VARCHAR(20) DEFAULT NULL, ADD name_english VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taught_course DROP course_code, DROP name_english');
