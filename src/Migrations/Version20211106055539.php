 ...
 */
final class Version20211106055539 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taught_course ADD is_graded SMALLINT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taught_course DROP is_graded');
