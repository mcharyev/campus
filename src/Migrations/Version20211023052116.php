 ...
 */
final class Version20211023052116 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transcript_course (id INT AUTO_INCREMENT NOT NULL, name_english VARCHAR(255) NOT NULL, name_turkmen VARCHAR(255) NOT NULL, letter_code VARCHAR(20) NOT NULL, credit_type SMALLINT NOT NULL, course_type SMALLINT NOT NULL, midterm SMALLINT NOT NULL, final SMALLINT NOT NULL, makeup SMALLINT NOT NULL, siwsi SMALLINT NOT NULL, course_grade SMALLINT NOT NULL, teacher VARCHAR(255) NOT NULL, student_id INT NOT NULL, student_name VARCHAR(255) NOT NULL, year INT NOT NULL, semester SMALLINT NOT NULL, date_updated DATETIME NOT NULL, last_updater VARCHAR(255) NOT NULL, status SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
