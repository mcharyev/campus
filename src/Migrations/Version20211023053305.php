 ...
 */
final class Version20211023053305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE transcript_course (id INT AUTO_INCREMENT NOT NULL, name_english VARCHAR(255) NOT NULL, name_turkmen VARCHAR(255) NOT NULL, letter_code VARCHAR(20) NOT NULL, credit_type SMALLINT DEFAULT 1 NOT NULL, course_type SMALLINT DEFAULT 1 NOT NULL, midterm SMALLINT DEFAULT 0 NOT NULL, final SMALLINT DEFAULT 0 NOT NULL, makeup SMALLINT DEFAULT 0 NOT NULL, siwsi SMALLINT DEFAULT 0 NOT NULL, course_grade SMALLINT DEFAULT 0 NOT NULL, teacher VARCHAR(255) NOT NULL, student_id INT NOT NULL, student_name VARCHAR(255) NOT NULL, year INT NOT NULL, semester SMALLINT NOT NULL, date_updated DATETIME NOT NULL, last_updater VARCHAR(255) NOT NULL, status SMALLINT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE transcript_course');
