 ...
 */
final class Version20211030083237 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE enrolled_student ADD matriculation_date DATE DEFAULT NULL, ADD graduation_date DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE enrolled_student DROP matriculation_date, DROP graduation_date');
        $this->addSql('DROP INDEX UNIQ_6DC044C5B3A61235 ON `group`');
